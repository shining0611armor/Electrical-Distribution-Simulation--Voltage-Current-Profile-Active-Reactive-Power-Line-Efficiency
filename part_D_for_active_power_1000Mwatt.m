...
%-------------------part D
% ************************ part D with   active power : 1000 maga watt
...
L=400;% inkilometer
PL=1000*10^6;% active power : 1000 maga watt
cosphi=0.99;
...
figure('Name','partD - computer assignment - 1000 MW active power','NumberTitle','off')
