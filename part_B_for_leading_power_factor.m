...
%-------------------part B 
% ************************ part B with leading power factor
...
cosphi=0.99;
angle_of_cosphi= acosd(cosphi); %     ***lead power factor  (determined in it's sign)
...
figure('Name','partB - computer assignment - leading power factor','NumberTitle','off')
